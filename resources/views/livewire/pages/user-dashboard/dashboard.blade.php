            ...
            <div
                ...
                <div class="flex justify-between items-center mb-6">
                    <div class="flex items-center gap-3">
                        <button wire:click="prevMonth" @click="loadingMessage = '{{ __('loading.prev_month') }}'"
                        ...
                        <button wire:click="nextMonth" @click="loadingMessage = '{{ __('loading.next_month') }}'"
                            class="px-4 py-2 rounded-xl bg-gray-100 hover:bg-gray-200 transition">
                            Next →
                        </button>

                        <button wire:click="goToToday" @click="loadingMessage = '{{ __('loading.today') }}'"
                    ...
                    <select wire:model="year" wire:change="yearChanged"
                        @change="loadingMessage = '{{ __('loading.change_year') }}'"
                    ...
                    <table class="w-full border-collapse">
                        ...
                        <tbody class="text-gray-800 text-sm">
                            ...
                            <tr wire:key="attendance-{{ $key }}" wire:dblclick="openEditModal('{{ $key }}')"
                                @dblclick="loadingMessage = '{{ __('loading.open_editor') }}'" class="
